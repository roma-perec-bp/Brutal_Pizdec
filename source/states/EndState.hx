			...
			if (controls.ACCEPT)
			{
				...
				else
				{
					if(FlxG.save.data.playedSongs.contains('with-cone') && FlxG.save.data.playedSongs.contains('boom') && FlxG.save.data.playedSongs.contains('overfire') 
						...
						&&FlxG.save.data.playedSongs.contains('with-cone-original') && FlxG.save.data.playedSongs.contains('klork-old') &&FlxG.save.data.playedSongs.contains('t-short-original'))
					{
						...
						&&FlxG.save.data.playedSongsFC.contains('with-cone-original') && FlxG.save.data.playedSongsFC.contains('klork-old')&&FlxG.save.data.playedSongs.contains('t-short-original')))
					{
